...
arrayAssociativo['auto_privata'] = { icon: faCar, classe: 'myicon-padding icon-car' };
arrayAssociativo['transfer'] = { icon: faTaxi, classe: 'myicon-padding icon-taxi' };
arrayAssociativo['bus'] = { icon: faBus, classe: 'myicon-padding icon-bus' };
