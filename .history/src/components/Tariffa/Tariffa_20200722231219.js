                        ...
                        <div className="accordion__price black">
                            ...
                            <hr />
                            {
                                dati.partecipants.map((ele, i) => {
                                    return <div key={"partecipante-"+i} className='d-flex my-2'><span>{'Persona ' + (i + 1)}</span><span className="ml-auto secondary-color">{(ele.price).toFixed(2) + '€'}</span></div>
                                })
                            }
                            <hr />
                            ...
                            <div className="price__included secondary-color">
                                <p className="mycolor-orange">Cosa Comprende il prezzo</p>
                                <p>{dati.included}</p>
