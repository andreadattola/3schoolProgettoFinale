                ...
                return (
                    <div className='row' key={"transfer-" + i}>
                        ...
                        <div className='col-12 col-md-10'>
                            ...
                            <p><span className='taglia-testo color-text-grey text-small mt-1'>{transfer.description}</span><Link to="" onClick={() => utils.funzioneApriModale(setModTrasferimento, modTrasferimento)}>Scopri di più</Link></p>
