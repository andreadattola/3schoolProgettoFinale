            ...
            {contesto.map((transfer, i) => {
                return (
                    <div className='row' key={"transfer-" + i}>
                        <div className='col-5 col-md-2 mb-0'>
                        <FontAwesomeIcon className={"mb-0 myicon-padding "+utils.arrayAssociativo[transfer.typology].classe} icon={utils.arrayAssociativo[transfer.typology].icon} />
                        </div>
