                ...
                return (
                    <div className='row' key={"transfer-" + i}>
                        ...
                        <div className='col-10'>
                            ...
                            <p>DA <button className=' btn btn-outline-primary' disabled>{transfer.departure.name}</button></p>
                            <p>A <button className='btn btn-outline-primary' disabled>{transfer.arrival.name}</button></p>
