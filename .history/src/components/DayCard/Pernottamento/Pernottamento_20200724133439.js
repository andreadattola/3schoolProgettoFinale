                                ...
                                <div className="container">
                                    <div className="row">
                                        <div className="col-12 mb-1">
                                            ...
                                            <p className="text-small">Indirizzo: {acc.contact.address}<br/>Sito web: <a target="_blank" rel="noopener noreferrer" href={acc.contact.website}>{acc.contact.website}</a></p>
                                        </div>
                                    </div>
