                ...
                return (
                    <div className='row' key={"accomodation" - i}>
                        ...
                        <div className='col-12 col-lg-5'>
                            ...
                            <p className="text-medium"><span className='taglia-testo-pernottamento' >{acc.description}</span><Link to="" onClick={() => utils.funzioneApriModale(setModPernottamento, modPernottamento)}>Scopri di più</Link></p>
