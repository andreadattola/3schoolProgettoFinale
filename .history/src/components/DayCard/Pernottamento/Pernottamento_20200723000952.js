                ...
                return (
                    <div className='row' key={"accomodation" - i}>
                        ...
                        <div className='col-12 col-lg-5'>
                            ...
                            <span className="text-small"><span className='taglia-testo-pernottamento' >{acc.description}</span><Link to="" onClick={() => utils.funzioneApriModale(setModPernottamento, modPernottamento)}>Scopri di più</Link></span>
