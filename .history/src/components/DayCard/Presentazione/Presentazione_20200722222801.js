        ...
        <>
            <div className='row'>
                <div className='col-12'>
                    <h1 className='mycolor-orange title p-1'> {contesto.day.name}<span className=' mycolor-grey2 sub-title p-1'>{"  "+getDayMonth(contesto.data)}</span></h1>
                    <img alt="immagine" className='img-fluid' src={`${contesto.day.images[0].image}`} />
