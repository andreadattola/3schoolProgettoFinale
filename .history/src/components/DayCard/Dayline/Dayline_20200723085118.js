                ...
                <div className="col-12 text-center">
                    <div className="row flex-column align-items-center text-center">
                        <div className="col-4 p-0">
                            <div className="day-circle text-white tinyText">DAY <span className="text-large">{giorno}</span></div>
                        </div>


                        {Array(numeroAttivita).fill(null).map((att,i) => {
                            return <div key={"icon-act-"+i} className='col-2 text-center p-0'>
                                <div className="activity-circle"><FontAwesomeIcon icon={faMapMarker} /></div></div>
                        })}
                        {transports.map((tr,i) => {
                            return <div key={"icon-tr-"+i} className='col-2 text-center p-0'>
