...
export default function Login() {
    ...
    const checkLogin = async (ev) => {
        ev.preventDefault();
        const dbSalt = await postData("http://treeact.altervista.org/richiestasalt1357986420.php", { email: "davidefiguccia@treeact.it", hashcode: "9cb12c66a923f146fe34810d0bed39305a622ca51aca0cdd6804d9a841630cb97a3dec2ec6e1aa8dd661274625e6febb6ff06ca063f48650a40d23906ea63d6b" });
